#!/usr/bin/env python3
"""
Interactively replace identifiers in a file.

Usage:
    replace_identifiers.py [options] <input_file> <id_file>
...
def display_changes(i, old_line_c, new_line_c):
    print("")
    print(colored(f"Original line {i}: ", "light_blue"), old_line_c.strip())
    print(colored(f"Replaced line {i}: ", "light_blue"), new_line_c.strip())
